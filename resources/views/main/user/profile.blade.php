        ...
        <div
                ...
                <div class="bg-gray-900 rounded-xl p-4 border border-gray-700">
                    ...
                    <div id="orders" class="tab-content hidden">
                        <div class="flex items-center space-x-3 mb-3">
                            ...
                            <h2 class="text-lg font-semibold text-white">Riwayat Pemesanan</h2>
                        </div>
            ...
            <div class="mt-6 flex flex-col sm:flex-row justify-center gap-4">
                {{-- <a href="{{ route('user.edit.profile', ['slug' => $slug]) }}"
                    class="w-full sm:w-1/2 py-3 px-4 bg-teal-500 text-white font-semibold rounded-lg hover:bg-teal-600 transition duration-200 text-center">
                    Edit Profil
                </a> --}}
