...
@section('title', 'Edit Tabel - {{ $table->table_name }} - EvoKasir')
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-4xl">
        <div class="bg-gray-800/90 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg animate-scale-in">
            <h2
                ...
                <i class="fas fa-chair text-lg sm:text-xl"></i> Edit Tabel - {{ $table->table_name }}
            </h2>
            ...
            <!-- Form -->
            <form action="{{ route('admin.table.update', ['slug' => $slug, 'id' => $table->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <input type="text" name="table_name" id="table_name"
                        value="{{ old('table_name', $table->table_name) }}" required
