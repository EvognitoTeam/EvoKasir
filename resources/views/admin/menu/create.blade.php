...
@section('title')
    Tambah Menu - {{ $mitra->mitra_name }} - EvoKasir
@endsection
...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-4xl">
        <div class="bg-gray-800/90 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg animate-scale-in overflow-y-auto">
            <h2 class="text-2xl sm:text-3xl font-extrabold text-coral-500 mb-6 sm:mb-8 animate-text-reveal">Tambah Menu Baru
            </h2>
            ...
            <!-- Form -->
            <form action="{{ route('admin.menu.store', ['slug' => $slug]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6 sm:mb-8">
                    <label for="stock" class="block text-sm sm:text-base font-semibold text-gray-300">Stok
                        Tersedia</label>
