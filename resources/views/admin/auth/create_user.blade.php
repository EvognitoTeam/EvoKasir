    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-4xl">
        <div class="bg-gray-800/90 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg animate-scale-in">
            ...
            <form action="{{ route('admin.users.store', ['slug' => $slug]) }}" method="POST">
                ...
                <!-- Field Role (Baru) -->
                <div class="mb-4 sm:mb-6">
                    <label for="role" class="block text-sm sm:text-base font-semibold text-gray-300">Role</label>
                    <div class="relative">
                        <select name="role" id="role" required
                            class="mt-1 block w-full border border-gray-700 rounded-lg px-4 py-2 sm:py-3 text-gray-300 bg-gray-900 focus:outline-none focus:ring-2 focus:ring-coral-500 transition-all duration-200 appearance-none">
